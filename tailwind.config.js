...
module.exports = {
  content: ["./*.html"], // Esto le dice: "Busca clases de Tailwind en todos los .html de esta carpeta"
  darkMode: 'class',
  theme: {
    extend: {
      fontFamily: {
      ...
      colors: {
        ...
        // Colores antiguos para compatibilidad con la tienda y otras páginas no migradas aún
      ...
      'icon-pop': 'icon-pop 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards',
      }
    },
  },
  plugins: [],
